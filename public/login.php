...
<head>
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?php echo getStudentAssetUrl('vendor/css/pages/page-auth.css'); ?>" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1">Welcome to Student Portal! 👋</h4>
                        <p class="mb-6">Please sign-in to your account and start your journey</p>
