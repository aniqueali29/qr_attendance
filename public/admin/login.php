...
<head>
    ...
    <meta name="description" content="Admin login for QR Code Attendance System" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?php echo getAdminAssetUrl('vendor/css/pages/page-auth.css'); ?>" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.php" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo menu-text fw-bold">QR Attendance</span>
                            </a>
                        </div>
                        <!-- /Logo -->
