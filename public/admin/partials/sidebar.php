...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item <?php echo isPageActive('index') ? 'active' : ''; ?>">
        ...
        <!-- Students -->
        <li class="menu-item <?php echo isPageActive('students') ? 'active' : ''; ?>">
        ...
        <!-- Attendance -->
        <li class="menu-item <?php echo isPageActive('attendances') ? 'active' : ''; ?>">
            <a href="attendances.php" class="menu-link">
        ...
        <!-- Import/Export -->
        <!-- <li class="menu-item <?php echo isPageActive('importexport') ? 'active' : ''; ?>">
            <a href="importexport.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-upload"></i>
                <div class="text-truncate">Import/Export</div>
            </a>
        </li> -->
        
        <!-- Settings -->
        <li class="menu-item <?php echo isPageActive('settings') ? 'active' : ''; ?>">
